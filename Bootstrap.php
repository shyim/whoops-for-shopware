...
class Shopware_Plugins_Core_WhoopsForShopware_Bootstrap extends Shopware_Components_Plugin_Bootstrap {
	...
	public function onShopwareStartDispatch(Enlight_Event_EventArgs $args) {
		if($args->getSubject()->getParam('noErrorHandler')) {
			...
			$whoops->register();
		} // END if($args->getSubject()->getParam('noErrorHandler'))
	} // END public function onShopwareStartDispatch()
	...
	} // END public function loader($className)
} // END class Shopware_Plugins_Core_WhoopsForShopware_Bootstrap extends Shopware_Components_Plugin_Bootstrap